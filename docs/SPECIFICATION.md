...
| B6 | **Given** тип 100 минут, день без броней, дата в будущем внутри окна **When** запрошены слоты **Then** ровно 5 слотов, первый 09:00–10:40, последний 15:40–17:20; слот, выходящий за 18:00, не генерируется |
